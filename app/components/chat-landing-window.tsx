                  ...
                  <div className="h-full w-full">
                    <div className="flex h-full w-full flex-col">
                      <div className="flex items-center gap-3 mb-3">
                        <div className="w-9 h-9">
                          <div className="relative h-full w-full rounded-md flex items-center justify-center">
                            <svg width="24" height="24" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-700 dark:text-gray-300">
                        ...
                        <h4 className="text-xl md:text-2xl tracking-tighter leading-tight text-gray-900 dark:text-gray-100">Deep Patent Portfolio</h4>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Fundamental patents cover our core protocol, data structures, and agent behavior, creating a defensible technological foundation.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="h-full w-full">
                    <div className="flex h-full w-full flex-col">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="text-xl md:text-2xl tracking-tighter leading-tight text-gray-900 dark:text-gray-100">Composable Protocol Stack</h4>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Our layers are designed to compound. Data verified in one layer unlocks capabilities in others, creating a powerful flywheel effect.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="h-full w-full">
                    <div className="flex h-full w-full flex-col">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="text-xl md:text-2xl tracking-tighter leading-tight text-gray-900 dark:text-gray-100">Generational Team</h4>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Our founding and advisory team has a track record of over $10B in exits across infrastructure, AI, security, and global marketplaces.
                        </p>
                      </div>
                    </div>
                  </div>
