...
export function ChatLandingWindow() {
  ...
  const handleBadResponse = () => {
    ...
    // Here you could send feedback to analytics or backend
    console.log('Bad response feedback submitted')
  }
  ...
  return (
      ...
      <section id="chat-demo-section" className="flex flex-col items-center justify-center h-screen w-full px-4 py-8">
        ...
        <div className="flex h-full flex-col overflow-hidden">
          ...
          {messages.length === 0 ? (
            ...
            <>
              {/* Chat messages */}
              <div className="relative flex-1 space-y-0 px-2">
                              ...
                              <div className="w-full">
                                <div className="flex gap-3 items-start">
                                  ...
                                  <div className="flex-shrink-0">
                                    <svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="rounded-lg">
                                ...
                                >
                                  <MessageAction tooltip="Good response" delayDuration={100}>
                                    <Button
                                      variant="ghost"
                                      size="icon"
                                      className={cn(
                                        "rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800",
                                        feedback === 'good' && "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                      )}
                                  ...
                                  <MessageAction tooltip="Bad response" delayDuration={100}>
                                    <Button
                                      variant="ghost"
                                      size="icon"
                                      className={cn(
                                        "rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800",
                                        feedback === 'bad' && "bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300"
                                      )}
                                  ...
                                  <MessageAction tooltip="Share" delayDuration={100}>
                                    <Button
                                      variant="ghost"
                                      size="icon"
    ...
    <section id="trust-protocol-section" className="flex flex-col items-center justify-center h-screen w-full px-4 py-8">
      ...
      <section id="architecture-section" className="flex flex-col items-center justify-center min-h-screen w-full px-4 py-8">
        <div className="w-full max-w-6xl mx-auto">
          <div className="relative w-full">
            ...
            <div className="w-full max-w-4xl mx-auto">
              <div className="grid w-full grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-stretch">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100">Deep Patent Portfolio</div>
                  </div>
                  <div className="text-gray-600 dark:text-gray-400">Fundamental patents cover our core protocol, data structures, and agent behavior, creating a defensible technological foundation.</div>
                </div>
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100">Composable Protocol Stack</div>
                  </div>
                  <div className="text-gray-600 dark:text-gray-400">Our layers are designed to compound. Data verified in one layer unlocks capabilities in others, creating a powerful flywheel effect.</div>
                </div>
                ...
                <div className="flex flex-col relative">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100">Generational Team</div>
                  </div>
                  <div className="text-gray-600 dark:text-gray-400">Our founding and advisory team has a track record of over $10B in exits across infrastructure, AI, security, and global marketplaces.
                  </div>
                </div>
