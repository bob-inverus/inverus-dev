...
import { QueryProgressBar } from "./query-progress-bar"
      ...
      <div className="relative order-2 px-2 pb-3 sm:pb-4 md:order-1">
        ...
        >
          <FileList files={files} onFileRemove={onFileRemove} />
                    ...
                    <PromptInputTextarea
            placeholder="e.g. Sarah Connor from New York — sarah@example.com"
          ...
          {/* Query Progress Bar - Below actions */}
          <QueryProgressBar value={value} />
        </PromptInput>
      </div>
    </div>
  )
