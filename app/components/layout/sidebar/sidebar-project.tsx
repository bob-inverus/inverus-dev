  ...
  if (!user) {
    return (
      <div className="mb-5">
        <Link
          href="/auth"
          className="hover:bg-accent/80 hover:text-foreground text-muted-foreground group/new-chat relative inline-flex w-full items-center rounded-md bg-transparent px-2 py-2 text-sm transition-colors"
        >
