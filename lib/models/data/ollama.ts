...
// Simple check: enabled by default unless explicitly disabled
  ...
  try {
    ...
    return data.models.map((model): ModelConfig => {
      ...
      return {
        ...
        webSearch: true, // Enable database search functionality
...
const staticOllamaModels: ModelConfig[] = [
  {
    ...
    description: "Compact Llama 3.2 1B model running locally via Ollama",
    tags: ["local", "open-source", "fast", "1b"],
    ...
    apiSdk: (apiKey?: string) =>
      openproviders("llama3.2:1b" as string, undefined, apiKey),
  },
  {
    id: "llama3.2:latest",
